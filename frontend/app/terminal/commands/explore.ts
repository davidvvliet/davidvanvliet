...
const explore: Command = {
  ...
  execute: () => {
    const credits = [
      ...
      "__DIM__Apollo Image Archive (ASU), Apollo 15-17 orbit state vectors: https://apollo.sese.asu.edu/",
      "__DIM__NASA mission reports MSC-02680, MSC-05161, MSC-07230 and JSC-07904, Apollo 13 and 15-17 burn and entry conditions",
