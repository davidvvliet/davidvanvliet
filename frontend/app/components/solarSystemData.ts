...
export type MissionSpec = {
  ...
  /** While the clock is inside this window it runs at `speed` times true speed (default 1), whatever `time` is set to. */
  realtime?: { fromJD: number; toJD: number; speed?: number };
};
